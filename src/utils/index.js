...
exports.calculatePercentage = (results, total, options = { skipComments: false }) => {
  const filesCount = options.skipComments ? Object.keys(results).length : this.analyzeMatches(results).length;
